...
Namespace Evaluations
    ...
    Namespace GlobalLookup
        ...
        <Serializable()> _
        Public Class EvalGlobalLookup
            Inherits BusinessBase(Of EvalGlobalLookup)
...
#Region " Factory Methods "
            ...
            Friend Shared Function NewEvalGlobalLookup() As EvalGlobalLookup
                Return New EvalGlobalLookup()
            End Function

            Friend Shared Function GetEvalGlobalLookup(ByVal dr As SafeDataReader) As EvalGlobalLookup
                Return New EvalGlobalLookup(dr)
            End Function
...
#Region " Data Access "
            ...
            Friend Sub Insert(ByRef Conn As SqlConnection)
                ...
                Using cmd As SqlCommand = Conn.CreateCommand
                    ...
                    cmd.Parameters.AddWithValue("@Type", "eval")
