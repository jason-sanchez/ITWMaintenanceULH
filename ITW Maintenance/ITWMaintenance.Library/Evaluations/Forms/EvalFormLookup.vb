...
Namespace Evaluations
    ...
    Namespace Forms
        ...
        <Serializable()> _
        Public Class EvalFormLookup
            Inherits BusinessBase(Of EvalFormLookup)
...
#Region " Factory Methods "
            ...
            Friend Shared Function NewEvalFormLookup() As EvalFormLookup
                Return New EvalFormLookup()
            End Function

            Friend Shared Function GetEvalFormLookup(ByVal dr As SafeDataReader) As EvalFormLookup
                Return New EvalFormLookup(dr)
            End Function
...
#Region " Data Access "
            ...
            Friend Sub Insert(ByRef Conn As SqlConnection)
                ...
                Using cmd As SqlCommand = Conn.CreateCommand
                    ...
                    sql &= "('eval', @Description, @FormNumber, @FormField) "
