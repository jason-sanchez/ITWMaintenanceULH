...
Namespace Evaluations
    ...
    Namespace Forms
        ...
        Public Class EvalForm
            Inherits BusinessBase(Of EvalForm)
...
#Region " Business Methods "
            ...
            Private Shared EClassProperty As PropertyInfo(Of Integer) = RegisterProperty(New PropertyInfo(Of Integer)("EClass"))
            Public Property EClass() As Integer
                Get
                    Return GetProperty(Of Integer)(EClassProperty)
                End Get
                Set(ByVal value As Integer)
                    SetProperty(Of Integer)(EClassProperty, value)
                End Set
            End Property
            ...
            Public Property Outcome() As Boolean
                Get
                    Return GetProperty(Of Boolean)(OutcomeProperty)
                End Get
                Set(ByVal value As Boolean)
                    SetProperty(Of Boolean)(OutcomeProperty, value)
                End Set
            End Property
            ...
            'Private Shared ReportTemplateIDProperty As PropertyInfo(Of Integer) = RegisterProperty(New PropertyInfo(Of Integer)("ReportTemplateID", "Report Template ID"))
            'Public Property ReportTemplateID() As Integer
            '    Get
            '        Return GetProperty(Of Integer)(ReportTemplateIDProperty)
            '    End Get
            '    Set(ByVal value As Integer)
            '        SetProperty(Of Integer)(ReportTemplateIDProperty, value)
            '    End Set
            'End Property
...
#End Region
            ...
            Private Shared LookupListProperty As PropertyInfo(Of EvalFormLookupList) = RegisterProperty(New PropertyInfo(Of EvalFormLookupList)("LookupList"))
            Public Property LookupList() As EvalFormLookupList
                Get
                    Return ReadProperty(Of EvalFormLookupList)(LookupListProperty)
                End Get
                Set(ByVal value As EvalFormLookupList)
                    SetProperty(Of EvalFormLookupList)(LookupListProperty, value)
                End Set
            End Property
...
#Region " Validation Rules "
            ...
            Protected Overrides Sub AddBusinessRules()
                ...
                ValidationRules.AddRule(AddressOf Validation.CommonRules.StringMaxLength, _
                    New Validation.CommonRules.MaxLengthRuleArgs(EPathProperty, 200))
                ...
                'ValidationRules.AddRule(Of EvalForm)(AddressOf ValidFieldType(Of EvalForm), _
            ...
            'Private Shared Function ValidFieldType(Of T As EvalForm)(ByVal target As T, _
            ...
            '    Dim types As EvalFormFieldTypes = EvalFormFieldTypes.GetEvalFormFieldTypes()

            '    For Each type As EvalFormFieldTypes.NameValuePair In types
...
#Region " Factory Methods "
            ...
            Public Shared Function NewEvalForm(ByVal ParentEvalID As Integer) As EvalForm
                If Not CanAddObject() Then
                    Throw New System.Security.SecurityException("User not authorized to add an Eval Form")
                End If
                Return DataPortal.Create(Of EvalForm)(New CreateCriteria(ParentEvalID))
            End Function

            Public Shared Function GetEvalForm(ByVal EvalID As Integer) As EvalForm
                If Not CanGetObject() Then
                    Throw New System.Security.SecurityException("User not authorized to view an Eval Form")
                End If
                Return DataPortal.Fetch(Of EvalForm)(New Criteria(EvalID))
            End Function

            Public Shared Sub DeleteEvalForm(ByVal EvalID As Integer)
                If Not CanDeleteObject() Then
                    Throw New System.Security.SecurityException("User not authorized to remove an Eval Form")
                End If
                DataPortal.Delete(New Criteria(EvalID))
            End Sub

            Public Overloads Function Save() As EvalForm
                If IsDeleted AndAlso Not CanDeleteObject() Then
                    Throw New System.Security.SecurityException("User not authorized to remove an Eval Form")
                ElseIf IsNew AndAlso Not CanAddObject() Then
                    Throw New System.Security.SecurityException("User not authorized to add an Eval Form")
                ElseIf Not CanEditObject() Then
                    Throw New System.Security.SecurityException("User not authorized to update an Eval Form")
                End If
            ...
            Public Shared Sub CopyEval(ByRef ExistingForm As EvalForm, ByRef NewForm As EvalForm)
                ...
                NewForm.EClass = ExistingForm.EClass
                ...
                NewForm.Outcome = ExistingForm.Outcome
                ...
                For Each lookupValue As EvalFormLookup In ExistingForm.LookupList
                    Dim copyLookup As EvalFormLookup = EvalFormLookup.NewEvalFormLookup()
            ...
            Public Sub InsertField(ByVal InsertAt As Integer)
                ...
                For Each lookupValue As EvalFormLookup In LookupList
            ...
            Public Sub ClearField(ByVal FieldIndex As Integer)
                ...
                Dim removeList As EvalFormLookupList = EvalFormLookupList.NewEvalFormLookupList
                For Each lookupValue As EvalFormLookup In LookupList
                    If lookupValue.FormField = FieldIndex Then
                        removeList.Add(lookupValue)
                    End If
                Next
                For Each lookupValue As EvalFormLookup In removeList
...
#Region " Data Access "
            ...
            Private Overloads Sub DataPortal_Create(ByVal criteria As CreateCriteria)
                        ...
                        Using dr As New SafeDataReader(cmd.ExecuteReader)
                            If dr.Read() Then
                                ...
                                If ReadProperty(Of Integer)(EvalLevelProperty) = 3 Then
                                    ...
                                    ' The eGroup should be set to nothing so we know to set it to the EName (FormName) on Insert
                                    SetProperty(Of Integer)(EGroupOrderProperty, 0)
                                    SetProperty(Of String)(EGroupProperty, Nothing)
                                Else
                ...
                SetProperty(Of EvalFormLookupList)(LookupListProperty, EvalFormLookupList.NewEvalFormLookupList)
            End Sub
            ...
            Private Overloads Sub DataPortal_Fetch(ByVal Criteria As Criteria)
                Using conn As New SqlConnection(Database.ITWConnection)
                    ...
                    Using cmd As SqlCommand = conn.CreateCommand
                        ...
                        sql = "SELECT e.[ID], e.EvalID, e.ParentID, e.EvalLevel, "
                        sql &= "e.EName, e.ShortName, e.EPath, e.ReportDesc, "
                        sql &= "e.DOrder, e.Level2, e.Required, e.Discipline, "
                        sql &= "e.inactive, e.eGroupOrder, e.eGroup, "
                        sql &= "eel.fxnlObjFnd, eel.subjective, eel.Test, "
                        sql &= "eel.PatientGoal, eel.eClass, eel.calculated, eel.calculation, eel.NoResult, "
                        ...
                        sql &= "WHERE e.[EvalID] = @EvalID "

                        cmd.CommandType = CommandType.Text
                        cmd.CommandText = sql
                        cmd.Parameters.AddWithValue("@EvalID", Criteria.EvalID)
                        ...
                        Using dr As New SafeDataReader(cmd.ExecuteReader)
                            ...
                            With dr
                                ...
                                LoadProperty(Of Integer)(EClassProperty, .GetInt32("eClass"))
                                ...
                                'LoadProperty(Of Integer)(ReportTemplateIDProperty, .GetInt32("ReportTemplateID"))
                        ...
                        sql = "SELECT count(c.[ID]) AS TimesUsed "
                        sql &= "FROM [005CliTrans] c "
                        sql &= "INNER JOIN [001Episode] e ON c.epnum = e.epnum "
                        sql &= "WHERE c.TransID = " & Criteria.EvalID & " "
                        ...
                        LoadProperty(Of EvalFormLookupList)(LookupListProperty, EvalFormLookupList.GetEvalFormLookupList(ReadProperty(Of Integer)(EvalIDProperty)))
                    End Using
                End Using
            End Sub
            ...
            Protected Overrides Sub DataPortal_Insert()
                Using conn As New SqlConnection(Database.ITWConnection)
                    ...
                    Using cmd As SqlCommand = conn.CreateCommand
                        ...
                        SetProperty(Of String)(EPathProperty, ParentPath & ", " & ReadProperty(Of String)(FormNameProperty))
                        ...
                        Using dr As New SafeDataReader(cmd.ExecuteReader)
                            If dr.Read() Then
                                ...
                                SetProperty(Of String)(ShortNameProperty, Trim(Replace(ReadProperty(Of String)(EPathProperty), dr.GetString("EPath") & ", ", "")))
                            End If
                        End Using
                        ...
                        If String.IsNullOrEmpty(ReadProperty(Of String)(EGroupProperty)) Then
                            SetProperty(Of String)(EGroupProperty, ReadProperty(Of String)(FormNameProperty))
                        End If
                        ...
                        sql &= "inactive, ReportDesc, eGroupOrder, eGroup, evalForm) VALUES ("
                        ...
                        sql &= "'f" & ReadProperty(Of Integer)(EvalIDProperty) & "') "
                        'sql &= ReadProperty(Of Integer)(ReportTemplateIDProperty) & ") "
                        ...
                        sql = "INSERT INTO [100EvalEl] (evalID, fxnlObjFnd, subjective, "
                        sql &= "Test, PatientGoal, eClass, calculated, calculation, NoResult, "
                        sql &= "UseRptDesc, PedReq, problem, outcome, locked, LockNotes, "
                        ...
                        sql &= ReadProperty(Of Integer)(EClassProperty) & ", "
                ...
                For Each lookupValue In Me.LookupList
                    lookupValue.FormNumber = Me.EvalID
                Next
                LookupList.Save()
            End Sub
                ...
                If MyBase.IsDirty Then
                    Using conn As New SqlConnection(Database.ITWConnection)
                        ...
                        Using cmd As SqlCommand = conn.CreateCommand
                            ...
                            sql &= "EName = '" & Replace(ReadProperty(Of String)(FormNameProperty), "'", "''") & "', "
                            ...
                            'sql &= "ReportTemplateID = " & ReadProperty(Of Integer)(ReportTemplateIDProperty) & " "
                            ...
                            sql &= "eClass = " & ReadProperty(Of Integer)(EClassProperty) & ", "
