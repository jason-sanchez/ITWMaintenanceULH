...
Imports ITWMaintenance.Library.ReportTemplates

Namespace Nursing


    <Serializable()> _
    Public Class ReportTemplateSectionItem
        Inherits BusinessBase(Of ReportTemplateSectionItem)
...
#Region " Validation Rules "
        ...
        Protected Overrides Sub AddBusinessRules()
            ValidationRules.AddRule(Of ReportTemplateSectionItem)(AddressOf ValidFormID(Of ReportTemplateSectionItem), FormIDProperty)
        End Sub

        Private Shared Function ValidFormID(Of T As ReportTemplateSectionItem)(ByVal target As T, _
...
#Region " Factory Methods "
        ...
        Friend Shared Function NewReportTemplateSectionItem(ByVal FormID As Integer) As ReportTemplateSectionItem
            Return DataPortal.CreateChild(Of ReportTemplateSectionItem)(FormID)
        End Function

        Friend Shared Function GetReportTemplateSectionItem(ByVal dr As SafeDataReader) As ReportTemplateSectionItem
            Return DataPortal.FetchChild(Of ReportTemplateSectionItem)(dr)
        End Function
...
#Region " Data Access "
        ...
        Private Sub Child_Insert(ByVal ReportTemplate As ReportTemplate)
            ...
            Using conn As New SqlConnection(Database.ITWConnection)
                ...
                Using cmd As SqlCommand = conn.CreateCommand
                    ...
                    cmd.Parameters.AddWithValue("@DiagnosisID", ReportTemplate.ID)
        ...
        Private Sub Child_Update(ByVal ReportTemplate As ReportTemplate)
            '' If we're not dirty then don't update the database
            'If Not Me.IsDirty Then Exit Sub
        ...
        Private Sub Child_DeleteSelf(ByVal ReportTemplate As ReportTemplate)
            ' If we're not dirty then don't update the database
            If Not Me.IsDirty Then Exit Sub
