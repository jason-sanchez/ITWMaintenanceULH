...
Namespace Exports
    ...
    Public Class ExportParameters
        Inherits ReadOnlyBase(Of ExportParameters)
...
#Region "Factory Methods"
        ...
        Public Shared Function GetExportParam(ByVal ExportID As Integer) As ExportParameters
            Return DataPortal.Fetch(Of ExportParameters)(New Criteria(ExportID))
        End Function
                ...
                Using cmd As SqlCommand = conn.CreateCommand
                    ...
                    Using datareader As New SafeDataReader(cmd.ExecuteReader)
                        ...
                        With datareader
                            ...
                            Else
                                LoadProperty(Of Integer)(daterangelimitproperty, .GetInt32("daterangelimit"))
                            End If
