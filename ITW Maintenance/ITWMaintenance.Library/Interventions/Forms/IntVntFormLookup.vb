...
Namespace Interventions
    ...
    Namespace Forms
        ...
        <Serializable()> _
        Public Class IntVntFormLookup
            Inherits BusinessBase(Of IntVntFormLookup)
...
#Region " Factory Methods "
            ...
            Friend Shared Function NewIntVntFormLookup() As IntVntFormLookup
                Return New IntVntFormLookup()
            End Function

            Friend Shared Function GetIntVntFormLookup(ByVal dr As SafeDataReader) As IntVntFormLookup
                Return New IntVntFormLookup(dr)
            End Function
...
#Region " Data Access "
            ...
            Friend Sub Insert(ByRef Conn As SqlConnection)
                ...
                Using cmd As SqlCommand = Conn.CreateCommand
                    ...
                    sql &= "('IntVnt', @Description, @FormNumber, @FormField) "
