...
Namespace Nursing
    ...
    Namespace Diagnoses
        ...
        <Serializable()> _
        Public Class ReadOnlyDiagnosis
            Inherits ReadOnlyBase(Of ReadOnlyDiagnosis)
...
#Region " Factory Methods "
            ...
            Public Shared Function GetDiagnosisInfo(ByVal ID As Integer) As ReadOnlyDiagnosis
                If Not CanGetObject() Then
                    Throw New System.Security.SecurityException("User not authorized to view a Diagnosis")
                End If
                Return DataPortal.Fetch(Of ReadOnlyDiagnosis)(New Criteria(ID))
            End Function
