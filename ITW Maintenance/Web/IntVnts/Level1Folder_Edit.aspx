<%@ Page Title="ITW Maintenance - IntVnts - Level 1 Folder Edit" Language="VB" MasterPageFile="~/IntVnts/IntVntMainMaster.master" AutoEventWireup="false" CodeFile="Level1Folder_Edit.aspx.vb" Inherits="IntVnts_Level1Folder_Edit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" Runat="Server">
    ...
    <asp:FormView ID="frmEdit" runat="server" DataKeyNames="intVntID" DataSourceID="IntVntLevel1FolderDataSource" DefaultMode="Edit">
        <EditItemTemplate>
            <table border="0" cellpadding="5" cellspacing="0" class="form">
                <tr>
                    <td>Intervention ID:</td>
                    <td><asp:Label ID="intVntIDLabel" runat="server" Text='<%# Bind("intVntID") %>' /></td>
                </tr>
                <tr>
                    <td>Folder Name:</td>
    ...
    <csla:CslaDataSource ID="IntVntLevel1FolderDataSource" runat="server" 
        TypeName="ITWMaintenance.Library.Interventions.IntVntLevel1Folder, ITWMaintenance.Library" 
