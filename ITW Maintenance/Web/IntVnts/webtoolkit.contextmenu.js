...
var SimpleContextMenu = {
	...
	_show : function (e) {
		...
		if (menuElementId) {
			...
			// Modification: Rebuild the link based on the parent folder that was clicked.
			var link_NewForm = document.getElementById("a_NewForm");
			var link_NewFolder = document.getElementById("a_NewFolder");
			
			link_NewForm.href = "Form_Edit.aspx?intVntID=&ParentID=" + SimpleContextMenu._attachedElement.getAttribute("intVntID");
			link_NewFolder.href = "Folder_Edit.aspx?intVntID=&ParentID=" + SimpleContextMenu._attachedElement.getAttribute("intVntID");
			
			try {
			    var link_PasteForm = document.getElementById("a_PasteForm");
			    link_PasteForm.href = "Form_PasteCopied.aspx?ParentID=" + SimpleContextMenu._attachedElement.getAttribute("intVntID");
			} catch(ex) {
			    //alert(ex);
			}
			// End Modification
