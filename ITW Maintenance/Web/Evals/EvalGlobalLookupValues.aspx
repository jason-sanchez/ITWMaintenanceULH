<%@ Page Title="ITW Maintenance - Eval Global Lookup Values" Language="VB" MasterPageFile="~/MainMaster.master" AutoEventWireup="false" CodeFile="EvalGlobalLookupValues.aspx.vb" Inherits="Evals_EvalGlobalLookupValues" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" Runat="Server">
    ...
    <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
        <asp:View ID="ListView" runat="server">
            ...
            <asp:GridView ID="EvalGlobalLookupListGridView" runat="server" AutoGenerateColumns="False" 
                DataKeyNames="ID" DataSourceID="EvalGlobalLookupListDataSource" CellPadding="5" style="clear: both;">
                <EmptyDataTemplate>
                    No Eval Global Lookup Values Found
                </EmptyDataTemplate>
                <Columns>
    ...
    <csla:CslaDataSource ID="EvalGlobalLookupListDataSource" runat="server" 
        TypeAssemblyName="" TypeName="ITWMaintenance.Library.Evaluations.GlobalLookup.EvalGlobalLookupList, ITWMaintenance.Library" 
    ...
    <asp:ObjectDataSource ID="DescriptionDataSource" runat="server" 
        ...
        TypeName="ITWMaintenance.Library.Evaluations.GlobalLookup.EvalGlobalLookupDescriptionList"></asp:ObjectDataSource>
</asp:Content>
