...
var SimpleContextMenu = {
	...
	_show : function (e) {
		...
		if (menuElementId) {
			...
			link_NewForm.href = "Form_Edit.aspx?EvalID=&ParentID=" + SimpleContextMenu._attachedElement.getAttribute("EvalID");
			link_NewFolder.href = "Folder_Edit.aspx?EvalID=&ParentID=" + SimpleContextMenu._attachedElement.getAttribute("EvalID");
			
			try {
			    var link_PasteForm = document.getElementById("a_PasteForm");
			    link_PasteForm.href = "Form_PasteCopied.aspx?ParentID=" + SimpleContextMenu._attachedElement.getAttribute("EvalID");
			} catch(ex) {
			    //alert(ex);
			}
			// End Modification
