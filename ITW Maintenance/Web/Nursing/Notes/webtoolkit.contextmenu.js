...
var SimpleContextMenu = {
	...
	_show : function (e) {
		...
		if (menuElementId) {
			...
			link_NewForm.href = "Form_Edit.aspx?FormID=&ParentID=" + SimpleContextMenu._attachedElement.getAttribute("FolderID");
			link_NewFolder.href = "Folder_Edit.aspx?FolderID=&ParentID=" + SimpleContextMenu._attachedElement.getAttribute("FolderID");
			
			try {
			    var link_PasteForm = document.getElementById("a_PasteForm");
			    link_PasteForm.href = "Form_PasteCopied.aspx?ParentID=" + SimpleContextMenu._attachedElement.getAttribute("FolderID");
			} catch(ex) {
			    //alert(ex);
			}
			// End Modification
